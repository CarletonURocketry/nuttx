...
#define SNIOC_LSM6DSLSENSORREAD                                              \
  _SNIOC(0x0046) /* Arg: file *filep, FAR char *buffer,size_t buflen */
...
#define SNIOC_LSM303AGRSENSORREAD                                            \
  _SNIOC(0x0051) /* Arg: file *filep, FAR char *buffer,size_t buflen */
...
#define SNIOC_SET_TEMP_OFFSET                                                \
  _SNIOC(0x0055) /* Arg: uint16_t value (0.01 Kelvin) */
#define SNIOC_SET_PRESSURE_COMP                                              \
  _SNIOC(0x0056) /* Arg: uint16_t value (mbar) */
#define SNIOC_SET_ALTITUDE_COMP                                              \
  _SNIOC(0x0057)                        /* Arg: uint16_t value (meters) */
...
#define SNIOC_GET_BASELINE                                                   \
  _SNIOC(0x005a) /* Arg: struct sgp30_baseline_s*                            \
                  */
#define SNIOC_SET_BASELINE                                                   \
  _SNIOC(0x005b) /* Arg: const struct sgp30_baseline_s* */
...
#define SNIOC_SET_CLEAN_INTERVAL                                             \
  _SNIOC(0x005d) /* Arg: uint32_t value (seconds) */
...
#define SNIOC_SET_SCALE_XL                                                   \
  _SNIOC(0x006c) /* Set accelerator scale command                            \
                  */
...
#define SNIOC_ALS_CONFIG                                                     \
  _SNIOC(0x0093) /* struct                                                   \
                  * apds9922_als_setup_s* */
#define SNIOC_PS_CONFIG                                                      \
  _SNIOC(0x0094) /* struct                                                   \
                  * apds9922_ps_setup_s*  */
